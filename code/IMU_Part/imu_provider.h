...
float* ReadGyro(float *gyro)
{
   float *current_gyroscope_data_tmp = gyro;
   ICM42622::Icm42622ReadGyro(&current_gyroscope_data_tmp[0],
                                      &current_gyroscope_data_tmp[1],
                                      &current_gyroscope_data_tmp[2]);
  return gyro;
}
float* ReadAccelerometer(float *acceleration)
{
  float *current_acceleration_data     = acceleration;
  ICM42622::Icm42622ReadAccel(&current_acceleration_data[0],
